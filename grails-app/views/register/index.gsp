                ...
                <form class="form-signin" action="register" method="POST" id="loginForm" autocomplete="off">
                    <div class="form-group">
                        ...
                        <g:select class="form-control" name="role.id"
                                  from="${com.desiderantes.groovytest.Role.defaultRoles()}"
                                  optionKey="id" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" placeholder="Your full name" class="form-control" name="document" id="document" autocapitalize="none"/>
                    </div>
